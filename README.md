...
``` groovy
implementation 'com.github.cyclonesword.noproblem:no-problem-api:0.8.BETA3'
/* Gson provider or another of your preference */
 implementation 'com.github.cyclonesword.noproblem:gson-provider:0.8.BETA3'
```
#### Maven
